...
export_bucket = client.get_bucket("venren-zoomcamp-module3-hw-new")
...
for month in range(12,13):
    ...
    fileDownloaded = wget.download(mothly_file_download)
    ...
    export_bucket.blob(file_name_to_upload).upload_from_filename(fileDownloaded)
